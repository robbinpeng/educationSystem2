...
public class DictCreateController extends SelectorComposer<Component> {
	private static Logger logger = Logger.getLogger(DictCreateController.class);
    ...
    public void createGroup(Event e) {
		...
		boolean b = dictManager.createDict(dict);
		if(b){
			Messagebox.show("数据字典项创建成功！", "信息", Messagebox.OK, Messagebox.INFORMATION);
			...
			Messagebox.show("创建数据字典项出错！","错误",Messagebox.OK,Messagebox.ERROR);
		}
	}
